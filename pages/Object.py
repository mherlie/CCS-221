...
def _rectangle(bottom_lower=(0, 0, 0), side_length=5, length=-4):
...
def main():
    ...
    if object_type == "Rectangle":
        init_object = _rectangle(side_length=5, length=-4)
    elif object_type == "Right Triangle":
        init_object = right_tri(side_length=3)
    elif object_type == "Triangular Prism":
        init_object = tri_prism(side_length=5, side=4, two=2)
